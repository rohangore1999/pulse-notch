...
- A single-pass, interruption-safe downward morph with fast staged chart/actions, plus a three-minute trend, reset, snooze, and settings
...
- A local demo signal for testing the complete UI without a wearable
...
The heart menu-bar item also provides **Scan for Monitor** and **Toggle Demo Signal** for quick testing.
